...
const SearchFilters = () => {
    return (
        <div className="h-[48px] lg:h-[64px] flex flex-row lg:border justify-between items-center rounded-full">
            ...
            <div className="p-2">
                <div className="cursor-pointer p-2 lg:p-4 bg-airbnb rounded-full">
